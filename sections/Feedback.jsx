    ...
    >
      ...
      >
        ...
        <div>
          ...
          <p className="mt-[8px] font-normal sm:font-[18px] text-[12px] sm:leading-[22px] leading-[16px] text-white">Founder | Metaversus</p>
        </div>
        <p className="mt-[24px] font-normal sm:font-[24px] text-[18px] sm:leading-[45px] leading-[39px] text-white">
      ...
      >
        <img src="/planet-09.png" alt="planet-9" className="w-full lg:h-[610px] h-auto min-h-[210px] object-cover rounded-[40px]"/>
      <motion.div
